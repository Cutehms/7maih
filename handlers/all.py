  ...
  if text :
    if text == "منو ضافني" or text == "مين ضافني":
      ...
      if get:
        ...
        Bot("sendMessage",{"chat_id":chatID,"text":f"انت انضممت لوحدك 🔘","reply_to_message_id":message.message_id})
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/"+BOTATE)],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/Towasolbot")],[InlineKeyboardButton("قناة البوتات 🤖", url="t.me/BOTATE")]])
